                    ...
                    <div className="rounded-t bg-white mb-0 px-6 py-6">
                        ...
                        <div className="inputsprovedor">
                            ...
                            <div className="modal-botones">
                                ...
                                <button  className="bg-blue-500 text-white active:bg-blue-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" type="reset" value="finalizar" onClick={setoggle}>Finalizar</button>
                            </div>
                        </div>
</div> </div>
