...
import { customStyles, opcionesdepagina, columnasReserva } from "./Reserva.config";
            ...
            {(!nuevaReserva) ?
                ...
                (nuevaReserva.ProductoId === "") ?
                    ...
                    (nuevaReserva.ClienteId === "") ?
                        ...
                        : <FinishReservationForm cajaAbierta={cajaAbierta} nuevaReserva={nuevaReserva} setNuevaReserva={setNuevaReserva} handleClicksnakBar={handleClicksnakBar} />
            }
