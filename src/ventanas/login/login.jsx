                ...
                <div className="login-contenedor">
                    <div className="login-form">
                        ...
                        <Form  className="formulario">
                            ...
                            <input type="submit" value="Ingresar" className="bg-blue-500 text-white active:bg-blue-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 ease-linear transition-all duration-150" />
